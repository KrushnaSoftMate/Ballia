...
const Page = ({ params }) => {
  ...
  async function GetHashKeyData(x) {
    ...
    console.log("Headkey i got form backend--------------- :: ", haskey);
    if (!haskey?.data) {
      alert("Unable to fetch payment key. Try again.");
      return;
    }
    ...
    if (typeof window !== "undefined") {
      ...
      // var easebuzz = new window.EasebuzzCheckout('M6TD26M62', 'test');
      var easebuzz = new window.EasebuzzCheckout('2PBP7IABZ2', 'test')

      var options = {
        access_key: String(haskey?.data),
        ...
        onResponse: async (response) => {
          ...
          let res = await CustomerPayment(obj1);
          if (res === "true") {
