...
const Page = () => {
    ...
    const handleChange = (e) => {
        ...
        const safePan = /^[a-zA-Z0-9]*$/; // Allow only safe characters for pan
        ...
        <div style={{ display: "grid", width: '100%', alignItems: 'center', backgroundColor: '#f2f4f7', padding: '20px' }}>
          ...
          <input type="text" name="BillNumber" value={formData.propertyID} placeholder="Bill Number" onChange={handleChange} className='form-control mt-2' required />
                ...
                <div className="mx-2" style={{ width: '45%', padding: '8px' }} >
                    ...
                    <input type="number" name="Plot_No" value={formData.Plot_No || ""} placeholder="Plot/RG No" onChange={handleChange} className='form-control mt-2' />
                </div>
                <div className="mx-2" style={{ width: '45%', padding: '8px' }} >
                    <label style={{ fontWeight: 'bold' }}>Area(in meter squere)</label><br />
                    <input type="text" name="Area" value={formData.Area || ""} placeholder={"Area(in meter squere)"} onChange={handleChange} className='form-control mt-2' required />
                </div>
                <div className="mx-2" style={{ width: '45%', padding: '8px' }} >
