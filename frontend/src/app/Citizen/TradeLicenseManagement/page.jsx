    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <Link
                        href="/Citizen/TradeLicenseManagement/ApplyForTradeLicense"
                    ...
                    >
                        <div style={{ display: "grid", padding: "10px" }}>
                            ...
                            >
                                <img
                                    src="/Trade-License-Management.png"
                                    alt="My Applications"
                                    style={{ width: "4rem" }}
                                />
                            </div>
                            ...
                            >
                                ...
                                >
                                    <b>Apply for <br/>Trade License</b>
                                </p>
                                <img
                                    src="/Next-Arrow1.png"
                                    alt="Next Arrow"
                ...
                >
                    <Link
                        href="/Citizen/TradeLicenseManagement/GetLicenceDetails"
                        className="text-decoration-none"
                    >
                        <div style={{ display: "grid", padding: "10px" }}>
                            <div
                ...
                >
                    <Link
                        href={"/Citizen/TradeLicenseManagement/ViewBill"}
                        className="text-decoration-none"
                    >
                        <div style={{ display: "grid", padding: "10px" }}>
                            <div
