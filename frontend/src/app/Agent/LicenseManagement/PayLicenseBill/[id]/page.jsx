...
const page = ({ params }) => {
    ...
    const { GetLicenseBill, LicenseTokenPayment, LicenseTokenPaymentSuccess, LicenseCashPayBill } = statecalls;
    ...
    const getBill = async () => {
        const data = await GetLicenseBill(params.id);
        console.log(data);
    ...
    async function PayBill(e) {
        e.preventDefault()
        let objdemos={...billdata,...renderdata}
        const data = await LicenseTokenPayment(objdemos)
        console.log(data);
        ...
        var options = {
            ...
            onResponse: (response) => {
                ...
                LicenseTokenPaymentSuccess(obj)
    ...
    async function CashPay(e) {
        ...
        const data = await LicenseCashPayBill(obj)
        if (data) {
