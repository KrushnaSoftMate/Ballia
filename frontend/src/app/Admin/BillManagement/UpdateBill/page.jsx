...
const Page = () => {
  ...
  async function GetCustomer(e) {
    ...
    try {
      ...
      if (data.length > 0) {
        ...
        alert("No bill found for this customer. Please generate the bill first before proceeding to payment !!!")
  ...
  return (
                              ...
                              e.Approvance == "Approved" ? (
                                <>
                                  <button className="btn" style={{ backgroundColor: '#f1772e' }} onClick={() => SetLoading(true)}>
                                    ...
                                    <Link style={{ color: 'white', textDecoration: 'none', margin: '8px' }} href={"UpdateBill/" + e.PropertyID}>
                                      Edit Bill
                                    </Link>
                                  </button>
    ...
    //               <Link href={"UpdateBill/" + e.PropertyID}>
    //                 Edit Bill
    //               </Link>
    //             </button>
    //           </>
